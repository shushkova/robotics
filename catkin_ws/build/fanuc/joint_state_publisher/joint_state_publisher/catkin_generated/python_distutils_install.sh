...
echo_and_run cd "/home/vvshu/Desktop/thermalspray_cell/catkin_ws/src/fanuc/joint_state_publisher/joint_state_publisher"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/vvshu/Desktop/thermalspray_cell/catkin_ws/src/fanuc/joint_state_publisher/joint_state_publisher/setup.py" \
    egg_info --egg-base /home/vvshu/Desktop/thermalspray_cell/catkin_ws/build/fanuc/joint_state_publisher/joint_state_publisher \
    build --build-base "/home/vvshu/Desktop/thermalspray_cell/catkin_ws/build/fanuc/joint_state_publisher/joint_state_publisher" \
    install \
    --root="${DESTDIR-/}" \
